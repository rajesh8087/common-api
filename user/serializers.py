...
class UserRegistrationSerializer(serializers.ModelSerializer):
    ...
    employee_id = serializers.IntegerField(validators=[UniqueValidator(queryset=User.objects.all())], required=True,
                                           min_value=1)
    contact = serializers.IntegerField(validators=[UniqueValidator(queryset=User.objects.all()), contact_validator], required=True,
                                       min_value=1)
    ...
    class Meta:
        model = User
        fields = ['name', 'email', 'employee_id', 'contact', 'password', 'confirm_password', 'role', 'creator',
                  'reporting_to']
